...
export function MarketCrypto() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true); setCryptoError(null);
    try {
      ...
      <Card>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Actifs crypto en temps réel</p>
              </div>
            </div>
        ...
        <CardContent>
          ...
          <div className="flex space-x-2 mb-6">
            <Button onClick={()=>setSelectedFilter('all')} variant={selectedFilter==='all'?'primary':'secondary'} size="sm" className="flex-1">Toutes les cryptos</Button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-2xl font-bold text-orange-600">60s</p>
